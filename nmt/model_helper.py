...
def create_eval_model(model_creator, hparams, scope=None, extra_args=None):
  ...
  with graph.as_default(), tf.container(scope or "eval"):
    ...
    reverse_tgt_vocab_tables = vocab_utils.create_reverse_vocab_tables(tgt_vocab_file)
    #lookup_ops.index_to_string_table_from_file(tgt_vocab_file, default_value=vocab_utils.UNK)
    ...
    model = model_creator(
        ...
        source_vocab_tables=src_vocab_tables,
        target_vocab_tables=tgt_vocab_tables,
        reverse_target_vocab_tables=reverse_tgt_vocab_tables,
        scope=scope,
        extra_args=extra_args)
  return EvalModel(
      graph=graph,
